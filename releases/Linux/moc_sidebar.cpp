...
QT_MOC_LITERAL(1, 8, 17), // "notifyChangeTable"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11) // "tabletoShow"

    },
    "SideBar\0notifyChangeTable\0\0tabletoShow"
};
...
void SideBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->notifyChangeTable((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (SideBar::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SideBar::notifyChangeTable)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void SideBar::notifyChangeTable(QString _t1)
{
